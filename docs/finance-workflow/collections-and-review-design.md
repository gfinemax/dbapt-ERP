...
2026-09-19 후속 구현에서 고유 외부 조합원 ID 기반 부과 원본, 실제 입금의 부분 배분·취소 이력, 원수납 기반 환급의 분리 승인·실제 출금 연결, 간편지출 증빙 조회, 통합 월 마감 준비 점검을 추가했다. 이름 자동 매칭, 외부 원장 자동 동기화, 전자세금계산서 발행·세무 원장, 회계기간 잠금·재개방은 여전히 별도 범위다. 회계정책 확인 전 마감 확정·재개방 버튼은 제공하지 않는다.
