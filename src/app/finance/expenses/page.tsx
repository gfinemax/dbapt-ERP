...
export default async function Page({ searchParams }: { searchParams: Promise<{ kind?: string; connection?: string; q?: string; status?: string; source_kind?: string; source_id?: string }> }) {
