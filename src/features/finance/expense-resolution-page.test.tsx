...
describe("ExpenseResolutionPage", () => {
  ...
  it("prints project identity and the detailed expense rows for a batch resolution", () => {
    ...
    expect(expenseItemsTable?.querySelector("thead")).toHaveClass("border-y-2", "border-solid", "border-[var(--color-stone)]");
    expect(expenseItemsTable?.querySelector("tfoot")).toHaveClass("border-y-2", "border-solid", "border-[var(--color-stone)]", "text-center");
