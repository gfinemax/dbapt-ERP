...
export function QuickExpensePage({ attachEvidence, discardEvidence, getEvidenceOcrJob, importCardTransactions, linkCardTransaction, initialBankTransactions, initialBudgetItems = [], initialExpenseDetails = [], initialCardTransactions, initialRecords, persistRecord, uploadEvidence = uploadQuickExpenseEvidence }: {
