...
describe("FinanceReadinessPage", () => {
  it("separates missing configuration from operational queues", () => {
    render(<FinanceReadinessPage readiness={{ fiscalYear: 2026, configuration: { activeStaff: 2, missingRoles: ["마감"], verifiedTrustContracts: 1, operatingFundContracts: 0, currentYearBudgets: 3 }, queues: { cardLinkPending: 4, evidencePending: 2, resolutionRequired: 1, personalPaymentPending: 0, advanceSettlementOpen: 1, operatingPeriodOpen: 0, routeUnclassified: 3 } }} />);
