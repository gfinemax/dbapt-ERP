...
export const reimbursementCommandLabels: Record<string,string> = { BUDGET_ASSIGNMENT: "예산 귀속 확인·수정", SUBMIT: "정산 신청", EVIDENCE_APPROVE: "대체증빙 승인", EVIDENCE_SUPPLEMENT: "증빙 보완요청", EXCEPTION: "지연 정산 승인", SENIOR: "장기 지연 승인", OVER_BUDGET: "예산 초과 승인", APPROVE: "예산 반영 승인", REJECT: "반려", CANCEL: "신청 취소", PAY: "지급 연결", REVERSE_PAYMENT: "지급 연결 취소", AUTO_OPEN: "접수월 자동 개설", OPEN: "접수월 수동 개설", SUPPLEMENT: "보완 접수", CLOSE: "월 마감", POLICY: "운영 기준 변경", MEMBER: "담당자 권한 변경" };
