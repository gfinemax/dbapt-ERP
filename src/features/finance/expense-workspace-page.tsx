...
function ExpenseDetail({ canApprove, expenseDetails, record: r, staff }: { canApprove: boolean; expenseDetails: OperatingExpenseDetail[]; record: ExpenseWorkspaceRecord; staff: boolean }) {
