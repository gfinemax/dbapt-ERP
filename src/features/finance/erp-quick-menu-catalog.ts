...
export const quickMenuEntries = [
  ...
  { id: "corporate-use", label: "법인카드 간편처리", href: quickExpenseEntryHref("CORPORATE_CARD") },
  { id: "expense-entry", label: "지출 등록·신청", href: "/finance/expense-entry", badgeLabel: "지출 등록·신청" },
  { id: "personal-refund", label: "개인 선지출 정산", href: "/finance/reimbursements", badgeLabel: "조합 지급대기" },
