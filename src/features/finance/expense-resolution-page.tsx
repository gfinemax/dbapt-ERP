  ...
  return (
    <div className="overflow-x-auto border-y border-[var(--color-soft-border)] [border-bottom-style:dashed] [border-top-style:dashed]">
      <table className="w-full table-fixed border-collapse text-[13px]">
        ...
        <thead className="border-y-2 border-solid border-[var(--color-stone)] bg-[var(--color-cloud-veil)]">
          <tr>
        ...
        <tfoot className="border-y-2 border-solid border-[var(--color-stone)] bg-[var(--color-cloud-veil)] text-center font-bold">
          <tr>
