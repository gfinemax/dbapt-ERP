...
export const accountSubjectRecommendations: AccountSubjectRecommendation[] = [
  ...
  recommendation("OP-320", "도서인쇄비", "운영비", "운영비 예산안", "신문, 소식지, 사업추진 및 업무 관련 인쇄물", 320, ["인쇄비", "신문구독료", "봉투제작", "봉투인쇄", "명함", "책자", "제본"]),
  recommendation("OP-330", "사무등록비", "운영비", "운영비 예산안", "복사기, 회선, 문구류 및 기타 등록성 비용", 330, ["복사기", "회선료", "문구류"]),
